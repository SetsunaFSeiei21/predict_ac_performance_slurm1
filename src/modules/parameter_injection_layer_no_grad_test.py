...
class Parameter_Injection_Layer_No_Grad_Test(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.structure_refining = Encoder_No_Grad_Test(
            input_dim=input_dim,
        ...
        self.context_enhancing = Encoder_No_Grad_Test(
            input_dim=hidden_dim,
            hidden_dim=hidden_dim,
            output_dim=hidden_dim,
            num_heads=num_heads,
    ...
    def forward(
        ...
        structure_x, _ = self.context_enhancing(
            structure_x,
            attention_mask=None,
        )
