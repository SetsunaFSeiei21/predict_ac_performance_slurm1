...
from src.layers import Encoder_Detach_qkv

class Structure_Encoding_Layer_Detach_qkv(nn.Module):
    ...
    def __init__(self, input_dim: int, hidden_dim: int, output_dim: int, dropout: float, num_heads: int, attn_mask: torch.Tensor) -> None:
        ...
        self.context_enhancing = Encoder_Detach_qkv(input_dim=hidden_dim, hidden_dim=hidden_dim, output_dim=output_dim, num_heads=num_heads, dropout=dropout)
