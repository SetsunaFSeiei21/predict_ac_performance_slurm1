...
from src.modules import Parameter_Injection_Layer_No_Grad

class Zerosim_Device_WO_SE_No_Grad(Device_BaseModel):
    ...
    def __init__(self, feature_dim: int, hidden_dim: int, output_dim: int, dropout: float, num_heads: int, embedding_layer_num: int, 
        ...
        self.network = nn.ModuleDict({
            ...
            "parameter_injection_layer": nn.ModuleList([
                Parameter_Injection_Layer_No_Grad(input_dim=hidden_dim, hidden_dim=hidden_dim, output_dim=hidden_dim, dropout=dropout, num_heads=num_heads, 
