...
class ACCFormer(Device_BaseModel):
    ...
    def __init__(self, feature_dim: int, hidden_dim: int, output_dim: int, dropout: float, num_heads: int,
        ...
        self.network = nn.ModuleDict({
            ...
            "encoder": nn.ModuleList([
                Encoder(input_dim=hidden_dim, hidden_dim=hidden_dim, output_dim=hidden_dim, num_heads=num_heads, dropout=dropout) for _ in range(encoder_layer_num)
                ]),
