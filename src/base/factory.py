...
def build_model(model_name: str, model_hyper_parameters: Dict[str, Any], input_shape: Tuple[int, int],
    ...
    if model_name == "mlp":
        ...
        return model
    elif model_name == 'accformer_no_grad_test':
        if device_level_attn_mask is None:
            raise ValueError("accformer_no_grad_test requires device_level_attn_mask.")
        model = ACCFormer_No_Grad_Test(
            feature_dim=device_feature_dim, 
            hidden_dim=int(model_hyper_parameters['hidden_dim']),
            output_dim=int(model_hyper_parameters['output_dim']),
            dropout=float(model_hyper_parameters.get("dropout", 0.0)),
        ...
        return model
    elif model_name == 'gat_split_full':
        if device_level_attn_mask is None:
            raise ValueError("GAT_Split_Full requires device_level_attn_mask.")

        model = GAT_Split_Full(
            feature_dim=device_feature_dim,
            hidden_dim=int(model_hyper_parameters['hidden_dim']),
            output_dim=int(model_hyper_parameters['output_dim']),
            dropout=float(model_hyper_parameters.get("dropout", 0.0)),
        ...
        return model
    elif model_name == 'zerosim_device_no_grad_test':
        if device_level_attn_mask is None:
            raise ValueError("zerosim_device_no_grad_test requires device_level_attn_mask.")
        model = Zerosim_Device_No_Grad_Test(
            feature_dim=device_feature_dim,
            hidden_dim=int(model_hyper_parameters['hidden_dim']),
            output_dim=int(model_hyper_parameters['output_dim']),
            dropout=float(model_hyper_parameters.get("dropout", 0.0)),
        ...
        return model
    elif model_name == 'zerosim_device_final_no_grad_test':
        if device_level_attn_mask is None:
            raise ValueError("zerosim_device_final_no_grad_test requires device_level_attn_mask.")
        ...
        return model
    elif model_name == 'zerosim_device_detach_qk_wqwk':
        if device_level_attn_mask is None:
            raise ValueError("zerosim_device_detach_qk_wqwk requires device_level_attn_mask.")
        model = Zerosim_Device_Detach_qk_wqwk(
            feature_dim=device_feature_dim,
            hidden_dim=int(model_hyper_parameters['hidden_dim']),
            output_dim=int(model_hyper_parameters['output_dim']),
            dropout=float(model_hyper_parameters.get("dropout", 0.0)),
        ...
        return model
    elif model_name == 'zerosim_device_wo_se_no_grad':
        if device_level_attn_mask is None:
            raise ValueError("zerosim_device_wo_se_no_grad requires device_level_attn_mask.")
        model = Zerosim_Device_WO_SE_No_Grad(
            feature_dim=device_feature_dim,
            hidden_dim=int(model_hyper_parameters['hidden_dim']),
            output_dim=int(model_hyper_parameters['output_dim']),
            dropout=float(model_hyper_parameters.get("dropout", 0.0)),
        ...
        return model
    elif model_name == "zerosim_device_wo_se_no_grad_test":
        if device_level_attn_mask is None:
            raise ValueError("zerosim_device_wo_se_no_grad_test requires device_level_attn_mask.")
        model = Zerosim_Device_WO_SE_No_Grad_Test(
            feature_dim=device_feature_dim,
            hidden_dim=int(model_hyper_parameters['hidden_dim']),
            output_dim=int(model_hyper_parameters['output_dim']),
            dropout=float(model_hyper_parameters.get("dropout", 0.0)),
